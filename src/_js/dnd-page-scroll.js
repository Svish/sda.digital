/**
 * @see https://github.com/jevanlingen/dnd-page-scroll/blob/patch-1/lib/dnd-page-scroll.js
 */
(function (global, factory) {
  ...
  exports.default = function () {
      ...
      el.addEventListener('dragover', function (e) {
        if (doScroll == null) {
          doScroll = setInterval(function() {
            triggerScroll(e.target === topElement ? -options.scrollBy : options.scrollBy);
          }, options.delay);
        }
    ...
    eventDelegate.addEventListener('dragend', function () {
      clearScrollInterval();
      return hide(topElement, bottomElement);
    })
